...
export default function BookDetailPage() {
  ...
  const handleBorrowRequest = async (branchId?: string) => {
    ...
    if (!netState.isConnected) {
      ...
      Alert.alert(
        ...
        t("messages.borrow_queued_offline", "Yêu cầu mượn sách đã được lưu và sẽ tự động đồng bộ khi có mạng."),
      );
      return;
    }
    ...
    useUndoStore.getState().queueAction({
      message: t("messages.borrow_pending", `Đang xử lý mượn "${book?.title}"...`),
      duration: 5000,
      onUndo: () => {
        haptics.light();
      },
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      Alert.alert(t("common.error"), error.message || t("messages.review_failed"));
    } finally {
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerContent}>
            ...
            <View style={styles.bookInfoContainer} accessibilityRole="header">
              <View style={styles.coverShadow}>
                <Animated.Image
                  source={{
                    uri: book.cover_url || "https://via.placeholder.com/150",
                  }}
        ...
        <View style={styles.detailsSection}>
                ...
                <>
                  ...
                  >
                    <Text style={styles.viewAllAnnotationsText}>
                      {t("metadata.empty.view_all_annotations", "Xem tất cả ghi chú")}
                    </Text>
                    <Ionicons
                    ...
                    {!isOutOfStock ? (
                      <TouchableOpacity
                        style={[
                          ...
                          selectedBranch === bi.branch_id && styles.selectedBranchBtnActive
                        ]}
                        onPress={() => {
          ...
          <View style={styles.borrowContainer}>
            <TouchableOpacity
              ...
              accessibilityLabel={
                selectedBranch
                  ? t("member.borrow_branch_selected", "Mượn sách tại chi nhánh đã chọn")
            ...
            <TouchableOpacity
              ...
              accessibilityHint={t("community.activity_hint", "Mở lớp thảo luận cộng đồng và ghi chú cá nhân cho sách này")}
            >
              <LinearGradient
              ...
              >
                <Ionicons
                  ...
                  style={{ marginRight: 8 }}
                />
                <Text style={styles.borrowBtnText}>{t("community.activity")}</Text>
              </LinearGradient>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              accessibilityHint={t("member.ai_summary_hint", "Sử dụng trí tuệ nhân tạo để xem tóm tắt nội dung chính của sách")}
            >
              <LinearGradient
        ...
        {similarBooks && similarBooks.length > 0 ? (
          <View style={styles.recommendationsSection}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>{t("member.similar_books")}</Text>
          ...
          <View style={styles.ratingInputCard}>
            ...
            >
              {isSubmitting ? (
                ...
                <Text style={styles.submitBtnText}>{t("messages.submit_review")}</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.reviewsSection}>
          <Text style={styles.sectionTitle}>{t("messages.community_reviews")}</Text>
          {isReviewsLoading ? (
