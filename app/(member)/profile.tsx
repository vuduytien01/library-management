...
export default function ProfileScreen() {
  ...
  const statItemWidth =
    contentWidth < 420 ? "100%" : Math.min((contentWidth - 45) / 2, 360);
  const membershipCardWidth = Math.min(contentWidth * 0.85, 420);
  const chartWidth = Math.max(260, Math.min(contentWidth - 48, 680));
  const previewImageSize = Math.min(contentWidth * 0.9, 420);
    ...
    try {
      if (Platform.OS === "web") {
        ...
        if (element) {
          ...
          link.href = dataUrl;
          link.download = t("profile.download_filename", {
            name: profile?.fullName || "User",
          });
          link.click();
          Alert.alert(t("common.success"), t("profile.download_success"));
          return;
        }
      }
      ...
      >
          ...
          >
            <View style={styles.levelBadge}>
              <Text style={styles.levelText}>
                {t("profile.level_short").toUpperCase()} {profile?.level || 1}
              </Text>
            </View>
        ...
        <View style={styles.section}>
          ...
          <ViewShot ref={viewShotRef} options={{ format: "png", quality: 0.8 }}>
            <View
              ...
              style={{
                alignSelf: "center",
                width: membershipCardWidth,
                height: membershipCardWidth * 0.62,
                borderRadius: 20,
                overflow: "hidden",
              }}
            >
        ...
        <View style={styles.statsGrid}>
          <View
            style={[
              styles.statItem,
              { width: statItemWidth, backgroundColor: "#3A75F2" },
            ]}
          >
          ...
          <View
            style={[
              styles.statItem,
              { width: statItemWidth, backgroundColor: "#10B981" },
            ]}
          >
          ...
          <View
            style={[
              styles.statItem,
              { width: statItemWidth, backgroundColor: "#F59E0B" },
            ]}
          >
          ...
          <View
            style={[
              styles.statItem,
              { width: statItemWidth, backgroundColor: "#EF4444" },
            ]}
          >
        ...
        <View style={styles.actionSection}>
          ...
          >
            ...
            <Text style={styles.actionLabel}>{t("tabs.community")}</Text>
            <Ionicons name="chevron-forward" size={18} color="#5A5F7A" />
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.actionLabel}>{t("profile.badges")}</Text>
            <Ionicons name="chevron-forward" size={18} color="#5A5F7A" />
          </TouchableOpacity>
