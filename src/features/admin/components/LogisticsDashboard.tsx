...
interface LogisticsDashboardStyles {
  container: ViewStyle;
...
export const LogisticsDashboard = () => {
          ...
          <View style={styles.statusRow}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    item.status === "IN_PROGRESS" ? "#3A75F2" : "#8B8FA3",
                },
              ]}
            />
        ...
        <View style={{ alignItems: "flex-end", gap: 8 }}>
          <View style={styles.badgeRow}>
            ...
            >
              ...
              >
                {isHighPriority
                  ? t("admin.priority_high")
                  : t("admin.priority_standard")}
              </Text>
            </View>
          </View>
  ...
  return (
    <View style={styles.container}>
      <View
        style={
          Platform.OS === "web" ? styles.splitLayout : styles.verticalLayout
        }
      >
        ...
        <View style={styles.mapColumn}>
          ...
          <View style={styles.statsGrid}>
            <StatCard
              icon="truck-delivery"
              label={t("admin.active_deliveries")}
              value={tasks.length.toString()}
              color="#3A75F2"
            />
            <StatCard
              icon="package-variant-closed"
              label={t("admin.in_transit")}
              value={tasks
          ...
          <View style={styles.mapSection}>
            ...
            <View style={styles.mapWrapper}>
              <LogisticsMap tasks={tasks} hoveredTaskId={hoveredTaskId} />
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create<LogisticsDashboardStyles>({
