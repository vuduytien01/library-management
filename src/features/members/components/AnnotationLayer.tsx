    ...
    <View key={item.id} style={[styles.card, { borderLeftColor: item.color }]}>
      <View style={styles.cardHeader}>
        <View style={styles.userInfo}>
          <Text style={styles.userName}>
            {item.user?.fullName || t("community.reader")}
          </Text>
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            setAnnotations(
              annotations.filter((a: Annotation) => a.id !== item.id),
            );
      ...
      {item.is_public && (
        <View style={styles.publicBadge}>
          ...
          <Text style={styles.publicText}>{t("community.public")}</Text>
        </View>
      )}
    </View>
  );
      ...
      <BlurView intensity={80} tint="dark" style={styles.overlay}>
        <View style={styles.contentContainer}>
          <View style={styles.header}>
            <View>
              <Text style={styles.headerTitle}>{t("community.annotations_title")}</Text>
            ...
            <View style={styles.inputArea}>
              <View style={styles.colorPicker}>
                ...
                >
                  <Ionicons
                    ...
                    size={20}
                    color={isPublic ? "#3A75F2" : "#5A5F7A"}
                  />
                </TouchableOpacity>
              </View>
              <TextInput
                style={styles.input}
                placeholder={t("community.write_thought")}
              ...
              <View style={styles.inputActions}>
                ...
                <TouchableOpacity onPress={handleAdd}>
                  ...
                  >
                    <Text style={styles.submitText}>{t("community.save_annotation")}</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            </View>
